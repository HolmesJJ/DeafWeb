...
%mfcc Calculate the mel cepstrum of a signal C=(S,FS,W,NC,P,N,INC,FL,FH)
%
%
% Simple use: c=mfcc(s,fs)	% calculate mel cepstrum with 12 coefs, 256 sample frames
%				  c=mfcc(s,fs,'e0dD') % include log energy, 0th cepstral coef, delta and delta-delta coefs
%
% Inputs:
%     s	 speech signal
...
%      Version: $Id: mfcc.m,v 1.7 2009/10/19 10:20:32 dmb Exp $
%
